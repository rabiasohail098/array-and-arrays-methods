...
let arr:string[] = ["Arsalan","Hammad","Haroon","Sohail","Adeel","Maaz"] 
let num:number[] = [1,5,9,5,7,8]
...
let marks = [
    // class 1 // 0
    [
        [34,67,98],// student 1  index 0
    //   0  1   2
        [14,63,57], // student 2 index 1
    //   0   1  2
    ...
    // class 2 // 1
    [
        [56,90,34], // student 1 index 0
 //      0  1   2
        [45,98,45], // student 2 index 1
    //   0  1   2
...
let num2:number[] = [6,7,8,9,10]
let nums:number[] = num1.concat(num2)
// console.log(nums);

//join
let fruits:string[] = ["Apple","Mango","Grapes","Orange","Apple","Banana","Peach","Apple"]  
...
// console.log(alphabets);
                    //    0          1          2       3       4         5        6
let friends:string[] = ["Arsalan","Hammad","Sohail","Ahmed","Abdullah","Humair","Raza"]
...
let lower = friends.forEach((item)=>{console.log(item.toLowerCase());})